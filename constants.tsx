...
export const PRACTICE_AREAS: PracticeArea[] = [
  ...
  },
  {
    ...
    category: "4. Corporate & Business Advisory",
  ...
  {
    id: "ip-suite",
    category: "5. Intellectual Property (IP) Suite",
  ...
  {
    id: "startups-vc",
    category: "6. Startups & Venture Capital",
  ...
  {
    id: "data-privacy",
    category: "9. Data Privacy & Security",
...
export const TEAM_MEMBERS: TeamMember[] = [
  ...
  },
  {
    ...
    title: "Co-Founder & Senior Partner",
    imageUrl: "/sanjana.jpeg", // Updated with new image
    bio: [
      ...
      "Sanjana's core areas of practice include general litigation, corporate and business law, intellectual property rights, and data protection, with active involvement in both contentious and advisory roles. She has handled a wide range of civil and commercial disputes before various courts and tribunals, where her approach combines procedural clarity with a strategic understanding of each case's commercial or personal implications. Her litigation experience is complemented by consistent engagement in corporate advisory work, where she assists clients in matters such as contract structuring, compliance frameworks, risk management, and entity governance.",
