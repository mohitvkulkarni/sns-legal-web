                ...
                <CardActionArea component={RouterLink} to={`/blog/${post.id}`}>
                  <CardContent sx={{ p: 4, display: 'flex', flexDirection: 'column', height: '100%' }}>
                    <Box flexGrow={1}>
                        ...
                        <Typography variant="body1" color="text.secondary" sx={{ fontStyle: 'italic', borderLeft: 3, borderColor: 'secondary.light', pl: 2, my: 2 }}>
                            "{post.quote}"
                        </Typography>
                    </Box>
                    <Link
                      component="div"
                      variant="button"
                      sx={{ display: 'flex', alignItems: 'center', mt: 3, color: 'secondary.main', textDecoration: 'none' }}
                    >
